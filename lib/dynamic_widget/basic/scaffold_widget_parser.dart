...
class ScaffoldWidgetParser extends WidgetParser {
  ...
  Map<String, dynamic> export(Widget? widget, BuildContext? buildContext) {
    ...
    return <String, dynamic>{
      ...
      "bottomNavigationBar": DynamicWidgetBuilder.export(
          realWidget.bottomNavigationBar, buildContext), // <-- Tambah ini
  ...
  Widget parse(Map<String, dynamic> map, BuildContext buildContext,
    ...
    var scaffoldWidget = Scaffold(
      ...
      floatingActionButton: map.containsKey("floatingActionButton")
          ...
          : null,
      bottomNavigationBar: map.containsKey("bottomNavigationBar")   // <-- Tambah ini
          ? DynamicWidgetBuilder.buildFromMap(
              map["bottomNavigationBar"], buildContext, listener)
          : null,
